 ...
 * Keep aligned with `functions/src/workerAiPrescreen/evaluateAiHiringDecision.ts`.
 */
 ...
 * `submitWorkerAiPrescreenInterview` should pass `phase6AutomationQueued` from the actual write result of `maybeWritePhase6AutomationQueue`.
 */
