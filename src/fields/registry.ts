...
export const FieldRegistry: Registry = {
  ...
  jobTitle: { id: 'jobTitle', label: 'Job Title', type: 'text', usedBy: ['Both'] },
  endDate: { id: 'endDate', label: 'End Date', type: 'date', required: false, usedBy: ['Both'] },
  startDate: { id: 'startDate', label: 'Start Date', type: 'date', required: false, usedBy: ['Both'] },
  payRate: { id: 'payRate', label: 'Pay Rate', type: 'number', usedBy: ['Both'], hints: { unit: '$' } },
  ...
  workersNeeded: { id: 'workersNeeded', label: 'Workers Needed', type: 'number', usedBy: ['JobOrder'] },
  ...
  companyId: { id: 'companyId', label: 'Company Id', type: 'text', usedBy: ['JobOrder'] },
  companyName: { id: 'companyName', label: 'Company Name', type: 'text', usedBy: ['JobOrder'] },
  ...
  worksiteId: { id: 'worksiteId', label: 'Worksite Id', type: 'text', usedBy: ['JobOrder'] },
  worksiteName: { id: 'worksiteName', label: 'Worksite Name', type: 'text', usedBy: ['JobOrder'] },
  shiftType: { id: 'shiftType', label: 'Shift Type', type: 'select', options: [
    { value: 'day', label: 'Day' },
    { value: 'swing', label: 'Swing' },
    { value: 'night', label: 'Night' },
  ], usedBy: ['JobOrder'], tags: ['scheduling'] },
  ...
  backgroundCheck: { id: 'backgroundCheck', label: 'Background Check', type: 'boolean', usedBy: ['Both'], stage: 'scoping', path: 'scoping.compliance.backgroundCheck' },
  backgroundCheckPackages: { id: 'backgroundCheckPackages', label: 'Background Check Packages', type: 'multiselect', usedBy: ['Both'], stage: 'scoping', path: 'scoping.compliance.backgroundCheckPackages', optionsSource: 'companyDefaults' },
  drugScreen: { id: 'drugScreen', label: 'Drug Screen', type: 'boolean', usedBy: ['Both'], stage: 'scoping', path: 'scoping.compliance.drugScreen' },
  drugScreeningPanels: { id: 'drugScreeningPanels', label: 'Drug Screening Panels', type: 'multiselect', usedBy: ['Both'], stage: 'scoping', path: 'scoping.compliance.drugScreeningPanels', optionsSource: 'companyDefaults' },
  eVerify: { id: 'eVerify', label: 'E-Verify', type: 'boolean', usedBy: ['Both'], stage: 'scoping', path: 'scoping.compliance.eVerify' },
  requiredLicenses: { id: 'requiredLicenses', label: 'Required Licenses', type: 'multiselect', usedBy: ['Both'], stage: 'scoping', path: 'scoping.compliance.requiredLicenses', optionsSource: 'companyDefaults' },
  requiredCertifications: { id: 'requiredCertifications', label: 'Required Certifications', type: 'multiselect', usedBy: ['Both'], stage: 'scoping', path: 'scoping.compliance.requiredCertifications', optionsSource: 'companyDefaults' },
  experienceLevels: { id: 'experienceLevels', label: 'Experience Levels', type: 'multiselect', usedBy: ['Both'], stage: 'scoping', path: 'scoping.compliance.experienceLevels', optionsSource: 'companyDefaults' },
  educationLevels: { id: 'educationLevels', label: 'Education Levels', type: 'multiselect', usedBy: ['Both'], stage: 'scoping', path: 'scoping.compliance.educationLevels', optionsSource: 'companyDefaults' },
  physicalRequirements: { id: 'physicalRequirements', label: 'Physical Requirements', type: 'multiselect', usedBy: ['Both'], stage: 'scoping', path: 'scoping.compliance.physicalRequirements', optionsSource: 'companyDefaults' },
  languages: { id: 'languages', label: 'Languages', type: 'multiselect', usedBy: ['Both'], stage: 'scoping', path: 'scoping.compliance.languages', optionsSource: 'companyDefaults' },
  skills: { id: 'skills', label: 'Skills', type: 'multiselect', usedBy: ['Both'], stage: 'scoping', path: 'scoping.compliance.skills', optionsSource: 'companyDefaults' },
  ppe: { id: 'ppe', label: 'Required PPE', type: 'multiselect', usedBy: ['Both'], stage: 'scoping', path: 'scoping.compliance.ppe', optionsSource: 'companyDefaults' },
  ppeProvidedBy: { id: 'ppeProvidedBy', label: 'PPE Provided By', type: 'select', usedBy: ['Both'], stage: 'scoping', path: 'scoping.compliance.ppeProvidedBy' },
  uniformRequirement: { id: 'uniformRequirement', label: 'Uniform Requirement', type: 'select', usedBy: ['Both'], stage: 'scoping', path: 'scoping.compliance.uniformRequirement', optionsSource: 'companyDefaults' },
