...
export const FieldRegistry: Registry = {
  ...
  experienceLevel: { id: 'experienceLevel', label: 'Experience Level', type: 'select', optionsSource: 'experienceOptions', usedBy: ['Both'] },
  ...
  additionalScreenings: { id: 'additionalScreenings', label: 'Additional Screenings', type: 'multiselect', usedBy: ['All'], stage: 'scoping', path: 'scoping.compliance.additionalScreenings', optionsSource: 'companyDefaults' },
  eVerify: { id: 'eVerify', label: 'E-Verify', type: 'boolean', usedBy: ['All'], stage: 'scoping', path: 'scoping.compliance.eVerify' },
  licensesCerts: { id: 'licensesCerts', label: 'Licenses & Certifications', type: 'multiselect', usedBy: ['All'], stage: 'scoping', path: 'scoping.compliance.licensesCerts', optionsSource: 'credentialsSeed' },
  experienceLevels: { id: 'experienceLevels', label: 'Experience Levels', type: 'multiselect', usedBy: ['All'], stage: 'scoping', path: 'scoping.compliance.experienceLevels', optionsSource: 'experienceOptions' },
  educationLevels: { id: 'educationLevels', label: 'Education Levels', type: 'multiselect', usedBy: ['All'], stage: 'scoping', path: 'scoping.compliance.educationLevels', optionsSource: 'educationOptions' },
  ...
  skills: { id: 'skills', label: 'Skills', type: 'multiselect', usedBy: ['All'], stage: 'scoping', path: 'scoping.compliance.skills', optionsSource: 'onetSkills' },
