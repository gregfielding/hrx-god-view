 ...
 */
export function logPrescreenStepViewed(params: { stepId: string; stepIndex: number; totalSteps: number }): void {
  safeLogEvent(analytics, 'prescreen_step_viewed', params as Record<string, unknown>);
}

export function logPrescreenStepCompleted(params: { stepId: string }): void {
