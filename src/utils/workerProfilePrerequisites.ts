/**
 * Single source of truth for worker dashboard / profile “do we have X?” checks.
 * Keep in sync with `shared/workerProfilePrerequisites.ts` (CRA bundle cannot import outside `src/`).
 */
