...
interface AddUserNoteDialogProps {
  open: boolean;
  onClose: () => void;
  userId: string;
  userName: string;
...
const AddUserNoteDialog: React.FC<AddUserNoteDialogProps> = ({
  open,
  onClose,
  userId,
  userName,
  ...
  const handleAddNote = async () => {
    ...
    try {
      // Create note data - matches the structure used in NotesTab
      const noteData = {
      ...
      // Add note to Firestore - users/{uid}/notes collection
      ...
      <DialogContent>
        <Box sx={{ pt: 1 }}>
          <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
            Add notes, observations, and feedback about this contact. All notes trigger AI review for insights.
          </Typography>
          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
            ...
            <TextField
              ...
              placeholder="Enter your note, observation, or feedback about this contact..."
              variant="outlined"
...
export default AddUserNoteDialog;
