...
export const EXTERNAL_ONBOARDING_STEP_CATALOG: readonly ExternalOnboardingStepDefinition[] = [
  ...
  },
  {
    ...
    displayLabel: 'Handbook acknowledgment',
    appliesTo: 'w2',
    defaultBlocking: true,
    adminVerificationRequired: true,
  },
  {
    ...
    displayLabel: 'PTO acknowledgment',
    appliesTo: 'w2',
  ...
  },
  {
    ...
    displayLabel: 'Independent contractor agreement',
    appliesTo: '1099',
    defaultBlocking: true,
    adminVerificationRequired: true,
  },
  ...
  },
  {
    ...
    displayLabel: 'I-9 employee section',
    appliesTo: 'w2',
    defaultBlocking: true,
    adminVerificationRequired: true,
  },
  {
    ...
    displayLabel: 'Policies acknowledgment',
    appliesTo: 'both',
    defaultBlocking: true,
    adminVerificationRequired: true,
  },
