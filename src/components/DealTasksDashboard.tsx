  ...
  const handleAcceptSuggestion = async (suggestion: any) => {
    ...
    try {
      const taskData = {
        ...
        associations: {
          deals: [dealId],
          companies: deal?.companyId ? [deal.companyId] : [],
          contacts: deal?.contactIds || []
        },
        aiSuggested: true,
    ...
    <Box sx={{ p: 3 }}>
      ...
      {showCreateDialog && (
        <CreateTaskDialog
          ...
          tenantId={tenantId}
          preSelectedDeal={dealId}
          preSelectedCompany={deal?.companyId}
          preSelectedContacts={deal?.contactIds || []}
        />
      )}
