    ...
    <Stack id="worker-dashboard-action-items-region" spacing={2}>
      ...
      <Stack spacing={2} id="worker-dashboard-action-items">
        {items.map((item) => {
          ...
          // NOTE: 'assignment_confirmation_required' now renders via the
          // generic tile below — its CTA navigates to the jobs-board
          // posting (intent=accept) instead of confirming inline.
