...
export type FavoriteType = 'jobPosts' | 'users' | 'jobOrders' | 'companies' | 'worksites' | 'applications' | 'userGroups' | 'contacts';
...
class FavoritesService {
  ...
  getAllFavorites(tenantId: string): Record<FavoriteType, string[]> {
    ...
    const types: FavoriteType[] = ['jobPosts', 'users', 'jobOrders', 'companies', 'worksites', 'applications', 'userGroups', 'contacts'];
