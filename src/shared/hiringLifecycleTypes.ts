 ...
 * **Mirror of `shared/hiringLifecycleTypes.ts`** — CRA cannot import outside `src/`; keep both in sync.
...
/** AI hiring decision engine outputs (mirror of `evaluateAiHiringDecision`). */
