...
- [apollo null swallows failures](feedback_apollo_null_swallows_failures.md) — "apolloContactEnrichment returns null for no-match AND for 402/429/ECONNRESET alike — never write a permanent 'checked, found nothing' stamp off a bare null; probe the free /auth/health endpoint first (cost us 9 contacts 2026-08-24)"
