...
- [ontrac account](project_ontrac_account.md) — OnTrac via Indeed Flex: signed agreement terms (W-2 only, fixed markups, SLAs, screening + per-booking attestation), coverage-sheet deliverable, JIT Section-2 decision
