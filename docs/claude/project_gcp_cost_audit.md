...
- 2026-09-12 check: storage metric resumed publishing 09-11 15:54Z and reads **8.4105 TiB** — slightly ABOVE the 8.403/8.409 TiB pre-deletion baseline, 2 days after 1.8B docs were deleted, so Firestore has reclaimed nothing yet. Billing export now through 09-09: Cloud Firestore Storage $51.67/day (8.411 TiB avg), Zonal Backup Storage $17.20/day (16.796 TiB). Worth raising inside the already-open case 75352086 rather than waiting for the 09-17 trigger.
