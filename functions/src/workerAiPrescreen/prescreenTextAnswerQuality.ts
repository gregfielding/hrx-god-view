...
/** Pressure + supervisor: communication / professionalism under stress & references. */
...
/** Narrative quality deltas (additive); compliance/risk + vague/low-effort use calibrated flag penalties in scoreWorkerAiPrescreen. */
const MAX_QUALITY_PENALTY = 18;
const MAX_QUALITY_BOOST = 10;

/**
 * Full qualitative evaluation: tiers (motivation, experience, communication), flags, score delta.
 */
...
/** @deprecated Prefer `evaluatePrescreenAnswerQuality`. */
