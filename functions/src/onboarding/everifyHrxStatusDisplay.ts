/**
 * Mirror of `src/utils/everifyHrxStatusDisplay.ts` — keep in sync.
 */
...
export function everifyCaseDisplayLabel(args: { icaLine?: string | null; hrxNormalized: string }): string {
