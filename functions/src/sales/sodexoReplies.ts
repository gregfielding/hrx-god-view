...
async function classifyAndDraft(input: {
  ...
  const prompt = [
    ...
    `- Sign-off: close "Thank you!" then EXACTLY: a line with just "—", then "Greg Fielding · C1 Staffing · 925-448-0579", then "linkedin.com/in/gregpfielding". No bare "Greg" line (the doubled name looked broken in Gmail).`,
    ``,
