/**
 * Canonical application status vocabulary — **must stay in sync** with repo root `shared/applicationStatus.ts`.
 * Functions package compiles with `rootDir: src` only; duplicate definitions here by design.
 *
